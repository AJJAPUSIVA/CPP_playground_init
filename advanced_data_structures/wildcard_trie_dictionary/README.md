# Wildcard Trie Dictionary

## Problem Description

Support adding lowercase words and searching patterns where '.' matches any single character.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(words * length) | O(total characters) |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(pattern branching) | O(total characters) |

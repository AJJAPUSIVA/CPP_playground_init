...
Return the value that occurs more than floor(n/2) times. The input is guaranteed to contain one.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n) | O(1) optimal |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n) | O(1) optimal |

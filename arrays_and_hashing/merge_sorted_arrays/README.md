...
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O((n+m) log(n+m)) | O(n+m) output |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n+m) | O(n+m) output |

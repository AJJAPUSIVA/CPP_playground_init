...
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(mn) | O(1) optimal excluding output |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(mn) | O(1) optimal excluding output |

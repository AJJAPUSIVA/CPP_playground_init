# Memoized Sentence Construction

## Problem Description

Return whether a string can be segmented into one or more dictionary words.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | Exponential | O(n + dictionary) |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n^3) with substring construction | O(n + dictionary) |

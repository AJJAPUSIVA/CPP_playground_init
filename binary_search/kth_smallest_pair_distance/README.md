...
Return the k-th smallest absolute difference among all unordered pairs.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n^2) memory/time | O(1) excluding sort |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n log W + n log n) | O(1) excluding sort |

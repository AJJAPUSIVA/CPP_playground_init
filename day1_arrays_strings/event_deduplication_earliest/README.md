# Event Deduplication Earliest

## Problem Description

Given ordered events with id/timestamp/type, keep the earliest event for each id.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n*k) | O(k) |

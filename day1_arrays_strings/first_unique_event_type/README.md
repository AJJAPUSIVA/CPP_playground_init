...
Return the first label that occurs exactly once, or an empty optional.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n^2) | O(k) |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n) | O(k) |

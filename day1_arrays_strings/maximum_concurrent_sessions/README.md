...
Return the minimum number of meeting rooms required for half-open meeting intervals.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n^2 * range) | O(n) |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n log n) | O(n) |

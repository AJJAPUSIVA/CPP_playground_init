# Merge Overlapping Availability
...
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n^3) | O(n) output |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n log n) | O(n) output |

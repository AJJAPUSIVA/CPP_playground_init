# Shortest Service Hop Count

## Problem Description

Return the minimum number of directed service hops from source to target, or -1.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | Exponential | O(V+E) |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(V+E) | O(V+E) |

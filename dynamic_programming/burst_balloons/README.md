...
Given balloon values, maximize coins earned by choosing the order in which balloons are burst; bursting i earns left*i*right.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n!) | O(n^2) |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n^3) | O(n^2) |

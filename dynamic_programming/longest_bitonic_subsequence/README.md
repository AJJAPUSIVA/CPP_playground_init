...
Return the length of the longest subsequence that strictly increases and then strictly decreases.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n^3) | O(n) |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n^2) | O(n) |

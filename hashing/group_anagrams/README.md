...
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n^2 * k log k) | O(n*k) |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n*k + n log n) | O(n*k) |

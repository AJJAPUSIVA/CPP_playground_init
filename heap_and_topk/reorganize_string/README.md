...
Rearrange a string so no equal characters are adjacent; return empty when impossible.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | Exponential | O(alphabet) |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n log alphabet) | O(alphabet) |

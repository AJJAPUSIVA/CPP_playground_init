# Meeting Rooms Possible

## Problem Description

Return whether a person can attend all meetings represented by half-open intervals without overlap.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n^2) | O(1) excluding sort |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n log n) | O(1) excluding sort |

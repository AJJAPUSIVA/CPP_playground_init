...
Return the minimum arrows needed to burst all balloon intervals, where one arrow at x bursts every interval containing x.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | Exponential (small integer coordinates) | O(1) |

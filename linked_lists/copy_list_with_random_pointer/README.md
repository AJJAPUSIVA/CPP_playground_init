...
Deep-copy a linked list whose nodes have both next and random pointers.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n) | O(1) auxiliary optimal |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n) | O(1) auxiliary optimal |

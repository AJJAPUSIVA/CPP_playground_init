...
Implement a fixed-capacity least-recently-used cache with get and put.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n) per operation | O(capacity) |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(1) average | O(capacity) |

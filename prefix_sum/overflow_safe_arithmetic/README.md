...
Add two signed 64-bit integers and return an optional result that is empty when the mathematical sum overflows.
...
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(1) | O(1) |

# Two D Range Sum Query

## Problem Description

Preprocess a matrix and answer a list of inclusive rectangle-sum queries.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(queries * area) | O(m*n) |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(m*n + queries) | O(m*n) |

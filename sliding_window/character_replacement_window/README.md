...
Return the length of the longest substring that can be made of one repeated character after replacing at most k characters.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n^2) | O(alphabet) |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n) | O(alphabet) |

# Quickselect Kth Statistic

## Problem Description

Return the kth smallest value (1-indexed) in an unsorted integer array.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n log n) | O(1) extra |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n) average | O(1) extra |

...
Sort non-negative integers by popcount, breaking ties by numeric value.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n log n * word_bits) | O(1) |

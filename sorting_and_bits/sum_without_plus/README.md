...
Return the sum of two signed integers without using the + or - binary arithmetic operators in the optimal implementation.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(1) | O(1) |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(word bits) | O(1) |

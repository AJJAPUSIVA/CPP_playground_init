...
Implement a stack supporting push, pop, top, and getMin in constant time in the optimal design.

## Approaches

| File | Approach | Time Complexity | Extra Space |
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n) getMin | O(n) |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(1) all | O(n) |

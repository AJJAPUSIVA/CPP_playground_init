...
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n) | O(height) / O(width) |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n) | O(height) / O(width) |

...
Return whether sub is structurally/value-identical to some subtree of root.
...
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n+m) expected string search implementation dependent | O(n+m) |

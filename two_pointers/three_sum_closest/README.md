...
|---|---|---:|---:|
| `solution_brute_force.cpp` | Straightforward / baseline solution | O(n^3) | O(1) excluding sort |
| `solution_optimal.cpp` | Optimized interview-oriented solution | O(n^2) | O(1) excluding sort |
